<%@ Page Title="Edit User" Language="VB" MasterPageFile="~/AdminPortal/AdminPortal.master" AutoEventWireup="false" CodeFile="EditUser.aspx.vb" Inherits="AdminPortal_EditUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-horizontal">
        <h2>Edit the user account and press Update.</h2>
        <hr />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="drop_role" CssClass="col-md-2 control-label">User Role</asp:Label>
            <div class="col-md-10">
                <asp:DropDownList ID="drop_role" CssClass="form-control" runat="server" DataSourceID="SqlDataSource5" DataTextField="Name" DataValueField="Id"></asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="drop_role"
                    CssClass="text-danger" ErrorMessage="The role field is required." />
            </div>
        </div>
                <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="drop_active" CssClass="col-md-2 control-label">Activate/Deactivate</asp:Label>
            <div class="col-md-10">
                <asp:DropDownList ID="drop_active" CssClass="form-control" runat="server" DataSourceID="SqlDataSource4" DataTextField="activate_name" DataValueField="activate_id"></asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="drop_active"
                    CssClass="text-danger" ErrorMessage="The Activate/Deactivate field is required." />
            </div>
        </div>
        <div class="form-group">
